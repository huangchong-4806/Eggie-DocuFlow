...
1. 打开本项目右侧的 **Releases**
2. 下载最新版安装包
3. 解压后运行 `EggieDocuFlow_V1.3.1_mac.app`
...
3. Extract the package and launch `EggieDocuFlow_V1.3.1_mac.app`
...
1. 打开 `EggieDocuFlow_V1.3.1_mac.app`。 / Open `EggieDocuFlow_V1.3.1_mac.app`.
...
- `EggieDocuFlow_V1.3.1_mac.app`
- `EggieDocuFlow_V1.3.1_mac.zip`
