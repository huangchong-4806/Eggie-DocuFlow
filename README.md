...
Eggie DocuFlow 是一个面向日常办公场景的 Excel 与 PDF 工具。当前版本支持
...
1. 打开本项目右侧的 **Releases**
2. 下载最新版安装包
3. 解压后运行 `EggieDocuFlow_V1.3.0_mac.app`
...
3. Extract the package and launch `EggieDocuFlow_V1.3.0_mac.app`
...
1. 打开 `EggieDocuFlow_V1.3.0_mac.app`。 / Open `EggieDocuFlow_V1.3.0_mac.app`.
...
- `EggieDocuFlow_V1.3.0_mac.app`
- `EggieDocuFlow_V1.3.0_mac.zip`
